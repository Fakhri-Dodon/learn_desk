...
export default function StudentAssignmentShow({ assignment }) {
    ...
    const dataAssignment = assignment?.data ? assignment.data : assignment;

    const dataMateri = dataAssignment?.materi;
            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-white p-6 shadow-sm sm:rounded-lg border border-gray-200 mb-6">
                    ...
                    <div className="flex gap-4 mb-6 text-sm">
                        <span
                            className={`px-2 py-1 rounded-md font-semibold ${isSubmitted ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"}`}
                        >
                    ...
                    <div className="rounded-xl overflow-hidden shadow-inner bg-gray-900 mb-3">
                        <VideoPlayer
                            videoUrl={embedUrl}
                    ...
                    <div className="bg-white p-6 shadow-sm sm:rounded-lg border border-gray-200">
                        ...
                        >
                            ...
                            {assignment.submission_type === "link_video" && (
                                <div className="mb-4">
                                    <label className="block text-sm font-medium text-gray-700 mb-2">
                                        Masukkan Link Video (YouTube/Google
                                        Drive)
                                    </label>
                                    <input
                                        type="url"
                            ...
                            {assignment.submission_type === "google_form" && (
                                <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-md">
                                    <p className="text-sm text-blue-800 mb-3">
                                        Silakan kerjakan kuis melalui link
                                        Google Form di bawah ini. Jika sudah
                                        selesai, jangan lupa kembali ke halaman
                                        ini dan klik{" "}
                                        <strong>"Tandai Sudah Selesai"</strong>.
                                    </p>
                                    <a
                                        href={formatExternalUrl(assignment.google_form_link)}
                                        target="_blank"
                                        rel="noreferrer"
                    ...
                    <div className="bg-green-50 p-6 shadow-sm sm:rounded-lg border border-green-200">
                        ...
                        {assignment.submission_type === "google_form" && (
                            <p className="text-sm font-semibold text-green-800">
                                Kamu telah menandai tugas ini selesai melalui
                                Google Form.
                            </p>
                        )}
                    </div>
